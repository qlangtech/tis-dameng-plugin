 ...
 **/
public class DaMengSourceDTOColValProcess implements ISourceValConvert, Serializable {
     ...
     */
    public DaMengSourceDTOColValProcess(Map<String, FlinkColMapper> tabColsMapper) {
