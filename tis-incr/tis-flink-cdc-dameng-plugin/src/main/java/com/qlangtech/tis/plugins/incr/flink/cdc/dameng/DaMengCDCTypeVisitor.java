 ...
 **/
public class DaMengCDCTypeVisitor extends AbstractRowDataMapper.DefaultTypeVisitor {
    public DaMengCDCTypeVisitor(IColMetaGetter meta, int colIndex) {
        super(meta, colIndex);
    }
    ...
    public FlinkCol timestampType(DataType type) {
        ...
        return new FlinkCol(meta, type, new AtomicDataType(new TimestampType(nullable, 3)) //DataTypes.TIMESTAMP(3)
                ...
                , new FlinkCDCPipelineEventProcess(
                        org.apache.flink.cdc.common.types.DataTypes.TIMESTAMP(), new OracleFlinkCDCPipelineTimestampDataConvert())
