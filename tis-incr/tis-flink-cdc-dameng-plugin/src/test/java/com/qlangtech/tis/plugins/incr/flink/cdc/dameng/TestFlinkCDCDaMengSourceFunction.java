 ...
 * @date 2025/11/28
 */
public class TestFlinkCDCDaMengSourceFunction extends OracleSourceTestBase {
    private static final Logger LOG = LoggerFactory.getLogger(TestFlinkCDCDaMengSourceFunction.class);
    ...
    public void testBinlogConsume() throws Exception {
        ...
        FlinkCDCDaMengSourceFactory oracleCDCFactory = new FlinkCDCDaMengSourceFactory();
