...
public class TISOracleContainer extends JdbcDatabaseContainer<TISOracleContainer> {
    ...
    public TISOracleContainer(String dockerImageName) {
        this(DockerImageName.parse(dockerImageName));
    }

    public TISOracleContainer(final DockerImageName dockerImageName) {
        super(dockerImageName);
        dockerImageName.assertCompatibleWith(DEFAULT_IMAGE_NAME);
        preconfigure();
    }

    public TISOracleContainer(Future<String> dockerImageName) {
        super(dockerImageName);
        preconfigure();
    }
    ...
    @Override
    public TISOracleContainer withUsername(String username) {
    ...
    @Override
    public TISOracleContainer withPassword(String password) {
    ...
    @Override
    public TISOracleContainer withDatabaseName(String databaseName) {
    ...
    public TISOracleContainer usingSid() {
        this.usingSid = true;
        return self();
    }

    @Override
    public TISOracleContainer withUrlParam(String paramName, String paramValue) {
